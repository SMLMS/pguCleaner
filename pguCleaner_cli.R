...
main <- function(){
  ...
  #   model$scaleData()
  # methods <- c("none", "median", "mean", "mu", "mc", "knn", "pmm", "cart", "rf", "amelia")
  # missings <- pgu.missings$new(data = scaledData)
  # missings$setCleaningAgent <- method
  # print(missings$handleMissings(data = scaledData))
  # outliers <- pgu.outliers$new(data =scaledData)
  # outliers$setCleaningAgent <- methods[6]
  # print(scaledData)
  # outliers$handleOutliers(data = scaledData) %>%
  #   print()
  # print(outliers$cleaningAgent)
  # correlator <- pgu.correlator$new(data = scaledData)
  # print(correlator)
  # regressor <- pgu.regressor$new(data = scaledData)
  # print(regressor)
